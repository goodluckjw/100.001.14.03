...
def apply_josa_rule(find_word, replace_word):
        ...
        if not a_has_batchim:
            if not b_has_batchim:
                ...
                if b_has_rieul:
                    ...
                    return f'"{find_word}"를 "{replace_word}"으로 한다.'
        else:
            if not b_has_batchim:
                return f'"{find_word}"을 "{replace_word}"로 한다.'
            else:
                if b_has_rieul:
                    return f'"{find_word}"을 "{replace_word}"로 한다.'
                else:
    ...
    if found_josa == "를":
        if b_has_batchim:
            return f'"{find_word}"을 "{replace_word}을"로 한다.'
        else:
    ...
    if found_josa == "과":
        if b_has_batchim:
            ...
            return f'"{find_word}"를 "{replace_word}와"로 한다.'

    # 4. A와
    if found_josa == "와":
        if b_has_batchim:
            return f'"{find_word}"를 "{replace_word}과"로 한다.'
        else:
            return f'"{word_root}"를 "{replace_word}"로 한다.'
    ...
    if found_josa == "이":
        if b_has_batchim:
            ...
            return f'"{find_word}"를 "{replace_word}가"로 한다.'

    # 6. A가
    if found_josa == "가":
        if b_has_batchim:
            return f'"{find_word}"를 "{replace_word}이"로 한다.'
        else:
            return f'"{word_root}"를 "{replace_word}"로 한다.'
    ...
    if found_josa == "이나":
        if b_has_batchim:
            ...
            return f'"{find_word}"를 "{replace_word}나"로 한다.'

    # 8. A나
    if found_josa == "나":
        if b_has_batchim:
            return f'"{find_word}"를 "{replace_word}이나"로 한다.'
        else:
            return f'"{word_root}"를 "{replace_word}"로 한다.'
    ...
    if found_josa == "으로":
        if b_has_batchim:
            if b_has_rieul:
                return f'"{find_word}"를 "{replace_word}로"로 한다.'
            else:
                return f'"{word_root}"을 "{replace_word}"으로 한다.'
        else:
            return f'"{find_word}"를 "{replace_word}로"로 한다.'
        ...
        if a_has_batchim:
            if b_has_batchim:
                if b_has_rieul:
                    ...
                    return f'"{find_word}"를 "{replace_word}으로"로 한다.'
            else:
                return f'"{word_root}"을 "{replace_word}"로 한다.'
        else:
            if b_has_batchim:
    ...
    if found_josa == "는":
        if b_has_batchim:
            return f'"{find_word}"을 "{replace_word}은"으로 한다.'
        else:
            return f'"{word_root}"를 "{replace_word}"로 한다.'
    ...
    if found_josa == "은":
        if b_has_batchim:
            ...
            return f'"{find_word}"을 "{replace_word}는"으로 한다.'
